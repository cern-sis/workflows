...
class IOPParser(IParser):
    ...
    def _get_publication_info(self, article):
        ...
        return [
            {
                "journal_title": journal_title is not None and journal_title.text,
                "journal_volume": journal_volume is not None and journal_volume.text,
                "journal_year": journal_year,
                "journal_issue": journal_issue is not None and journal_issue.text,
                "journal_artid": journal_artid is not None and journal_artid.text,
            }
        ]
